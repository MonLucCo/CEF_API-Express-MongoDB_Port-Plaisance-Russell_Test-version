...
Les [tests E2E locaux](./tests/03-niveau-3-e2e.md#issue17--validation-initiale-de-lapi---tests-e2e-simulés) complètent :
...
Les documents [tests-strategy](./tests-strategy.md#niveau3--tests-e2e) et [03-niveau-3-e2e](./tests/03-niveau-3-e2e.md#1-tests-e2e-simulés-issue17) fournissent les précisions sur les modalités et le fonctionnement de ces tests E2E simulés.
