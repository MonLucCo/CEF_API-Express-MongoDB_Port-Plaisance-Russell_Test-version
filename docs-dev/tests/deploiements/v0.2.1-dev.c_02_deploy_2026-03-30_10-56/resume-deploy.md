# Résumé Déploiement — v0.2.1-dev.c

**📅 Date :** 3/30/2026, 11:00:45 AM  
**🧩 Pipeline :** 1.0.0  
...
Ce document résume l’exécution complète du pipeline de déploiement pour la version **v0.2.1-dev.c**.  
...
📁 Dossier créé : docs-dev/tests/deploiements/v0.2.1-dev.c_02_deploy_2026-03-30_10-56
...
Cette version fonctionne partiellement et nécessite un correctif (patch) pour compléter les traces et l'identification du dysfonctionnement du Login.
