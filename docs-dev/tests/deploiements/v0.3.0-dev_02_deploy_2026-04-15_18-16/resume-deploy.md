# Résumé Déploiement — v0.3.0-dev

**📅 Date :** 4/15/2026, 6:20:17 PM  
**🧩 Pipeline :** 1.0.0  
...
Ce document résume l’exécution complète du pipeline de déploiement pour la version **v0.3.0-dev**.  
...
Réponse (Version à déployer (ex : v0.2.0-dev) :) : v0.3.0-dev
📁 Dossier créé : docs-dev/tests/deploiements/v0.3.0-dev_02_deploy_2026-04-15_18-16
